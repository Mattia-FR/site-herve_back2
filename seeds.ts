...
export async function runSeeds(connection: Connection): Promise<void> {
  ...
  `);
    ...
    ("Mon processus de création", "mon-processus-creation", "De l'esquisse à la réalisation finale.", "Chaque réalisation a son histoire. Je partage ici mon processus de création étape par étape : l'inspiration, les croquis, la composition et le rendu final. Découvrez comment une idée prend forme.", "published", 2, NULL, "2024-02-10 14:30:00"),
    ("Techniques et matériaux", "techniques-materiaux", "Quelques bases sur les techniques utilisées.", "Cet article présente les techniques et matériaux que j'utilise au quotidien. Nous verrons les bases pour bien démarrer et progresser dans sa pratique.", "published", 1, NULL, "2024-03-05 09:15:00"),
    ("Projet en cours", "projet-en-cours", "Un aperçu des travaux en cours.", "Voici un aperçu de mes projets actuels. Certains sont encore en phase d'étude, d'autres en cours de finalisation.", "published", 2, NULL, "2024-03-20 11:00:00"),
  ...
  `);
	...
	// ============================================
	const imageRows: [string | null, string | null, string, string | null, boolean, number, number, number | null][] = [
		["Portrait", "Portrait réalisé aux crayons", "/uploads/gallery/portrait.jpg", "Portrait", true, 1, 1, 1],
		["Paysage", "Paysage à l'aquarelle", "/uploads/gallery/paysage.jpg", "Paysage", false, 0, 1, 1],
		["Esquisse", "Croquis préparatoire", "/uploads/gallery/esquisse.jpg", "Esquisse", true, 2, 2, 2],
		["Détail", "Détail d'une réalisation", "/uploads/gallery/detail.jpg", "Détail", false, 0, 2, 2],
		["Galerie 1", "Première image de galerie", "/uploads/gallery/galerie-1.jpg", "Galerie 1", true, 3, 1, 3],
		["Galerie 2", "Deuxième image de galerie", "/uploads/gallery/galerie-2.jpg", "Galerie 2", true, 4, 2, 4],
		["Hors article", "Image sans article lié", "/uploads/gallery/standalone.jpg", "Image standalone", true, 5, 1, null],
		...
		["Christophe", "Portrait Christophe", "/uploads/gallery/christophe.jpg", "Christophe", true, 14, 1, null],
		["Erwan", "Portrait Erwan", "/uploads/gallery/erwan.jpg", "Erwan", true, 15, 1, null],
		["François", "Portrait François", "/uploads/gallery/françois-.jpg", "François", true, 16, 1, null],
		["Gérard A4", "Gérard format A4", "/uploads/gallery/gerard-a4.jpg", "Gérard A4", true, 17, 1, null],
		...
		["Jacqueline", "Portrait Jacqueline", "/uploads/gallery/jacqueline.jpg", "Jacqueline", true, 20, 1, null],
		...
		["Matière 019", "Réalisation MATIERE019", "/uploads/gallery/MATIERE019.jpg", "MATIERE019", true, 26, 1, null],
		["Ophélie A4", "Ophélie format A4", "/uploads/gallery/ophelie-a4.jpg", "Ophélie A4", true, 27, 1, null],
		["Patricia", "Portrait Patricia", "/uploads/gallery/patricia.jpg", "Patricia", true, 28, 1, null],
		["Pauline", "Portrait Pauline", "/uploads/gallery/pauline.jpg", "Pauline", true, 29, 1, null],
		["Philippe", "Portrait Philippe", "/uploads/gallery/philippe.jpg", "Philippe", true, 30, 1, null],
		...
		["Sans titre", "Image sans titre", "/uploads/gallery/Untitled.jpg", "Sans titre", true, 48, 1, null],
		["Vanessa 2 A4", "Vanessa 2 format A4", "/uploads/gallery/vanessa-2-a4.jpg", "Vanessa 2 A4", true, 49, 1, null],
		["Vanessa A4", "Vanessa format A4", "/uploads/gallery/vanessa-A4.jpg", "Vanessa A4", true, 50, 1, null],
	...
	await connection.query(
		"UPDATE articles SET featured_image_id = 5 WHERE id = 3",
	);
	await connection.query(
		"UPDATE articles SET featured_image_id = 6 WHERE id = 4",
	);
